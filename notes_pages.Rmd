...
## Chinese: ANOVA
```{r Chinese_ANOVA, echo=FALSE, message=FALSE, warning=FALSE, results="asis", cache=FALSE}
#load("./assets/saved/20160425.RData")
...
## English: ANOVA
```{r English_ANOVA, echo=FALSE, message=FALSE, warning=FALSE, results="asis", cache=FALSE}
#load("./assets/saved/20160425.RData")
