...
To make sure the interaction of object size and match effects, the data set that illustrated the forest plot is analyzed by Bayesian ANOVA. The prior (r scale) for the fixed effects is 0.5, and the prior for the random effect (by subject variations) is 1. The interaction of object size and match effects is embedded in the four models as following.
